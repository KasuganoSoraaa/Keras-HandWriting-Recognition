...
# plt.show()
# show part of the picture from mnist

if K.image_data_format() == 'channels_first':
    x_train = x_train.reshape(x_train.shape[0], 1, img_rows, img_clos)
    x_test = x_test.reshape(x_test.shape[0], 1, img_rows, img_clos)
